...
Write-Output ""
Start-Sleep -Seconds 1
start-process powershell.exe -verb runas -wait -argumentlist {Set-ItemProperty Registry::HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run -Name Scriptrun -Value {"C:/files/scripts/click me.bat"} -Force ; Unblock-File 'C:/files/scripts/click me.bat' -force}
