...
Clear-Host
Write-Output "Removing bloatware now..."
...
Function Start-Debloat {
    ...
    Microsoft.VP9VideoExtensions|Microsoft.WebMediaExtensions|Microsoft.WebpImageExtension|Microsoft.WindowsNotepad|MicrosoftCorporationII.QuickAssist|Microsoft.DesktopAppInstaller'
...
Function FixWhitelistedApps {
    ...
    If(!(Get-AppxPackage -AllUsers | Select-Object Microsoft.Paint3D, Microsoft.MSPaint, Microsoft.WindowsCalculator, Microsoft.WindowsStore, Microsoft.MicrosoftStickyNotes, Microsoft.WindowsSoundRecorder, Microsoft.Windows.PhotosMicrosoft.WindowsNotepad, MicrosoftCorporationII.QuickAssist, Microsoft.DesktopAppInstaller)) {
...
Write-Output "systeem preperatie word gestart"
Begin-SysPrep
Write-Output "bloatware apps worden verwijderd"
Start-Debloat
Write-Output "bloatware registry keys worden verwijderd."
Remove-Keys
Write-Output "controleren of whitelisted apps zijn verwijderd, zo ja worden ze opnieuw geinstalleerd"
FixWhitelistedApps
Write-Output "onnidge scheduledtasks verwijderen, telemetry word verwijderd en ervoor zorgen dat bloatware niet terugkomt"
Protect-Privacy
CheckDMWService
CheckInstallService
...
New-Item $env:windir\temp\bloatware.txt -Value {1} -ErrorAction SilentlyContinue -Force 
exit